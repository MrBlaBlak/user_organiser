...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="/users/edit" class="user" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" class="form-control form-control-user" id="inputPassword" placeholder="hasło użytkownika">
                </div>
